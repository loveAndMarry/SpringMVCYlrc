...
public class User {
     ...
     * 
     */
    private List<String> userExpectation;
	...
	public int getUserAptitude() {
		return userAptitude;
	}

	public void setUserAptitude(int userAptitude) {
	...
	public List<String> getUserExpectation() {
		return userExpectation;
	}

	public void setUserExpectation(List<String> userExpectation) {
