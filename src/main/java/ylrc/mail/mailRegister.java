...
//保存验证码
    ...
    public static String myEmailAccount = "yuanlairuci_admin@163.com";
    public static String myEmailPassword = "ylrc123";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
    public static String myEmailSMTPHost = "smtp.163.com";

    public boolean SendMail(String receiveMailAccount) throws Exception {
		...
		*/
        ...
        //  From: 发件人
        message.setFrom(new InternetAddress(myEmailAccount, "缘来如此婚恋交友网站", "UTF-8"));
        ...
        //  Subject: 邮件主题
        message.setSubject("会员注册验证码", "UTF-8");
        ...
        // 7.需要一个临时数据表保存注册信息
        // (1) 保存receiveMailAccount和随机码到该临时数据表
    ...
    public void setMessageContent(Message message, String ContentType,String RandomCode) throws MessagingException {
        String Content="尊敬的用户，您好！欢迎您加入“缘来如此”，您的验证码是： "+RandomCode;
